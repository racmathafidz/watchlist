        ...
        return (
            <div className="w-full h-full sm:h-96 lg:h-120 xl:h-140">                
                <img 
                    ...
                    src={detailData.backdrop_path ? `https://image.tmdb.org/t/p/original/${detailData.backdrop_path}` : `https://upload.wikimedia.org/wikipedia/en/c/c8/Very_Black_screen.jpg`} 
                    alt="Backdrop" 
                    align="right"
                />            
                <div className="flex flex-col w-full content-center justify-start px-3 sm:px-5 xl:px-8 sm:z-10 sm:absolute h-full sm:h-96 lg:h-120 xl:h-140 sm:bg-gradient-to-r sm:from-black sm:via-black">
                    <div className="my-auto xl:pb-20 sm:w-1/2">
                        ...
                        <p className="sm:text-sm lg:text-base mb-4 text-justify font-light font-description">{detailData.overview ? detailData.overview : ""}</p>
                        <p 
                            className="sm:text-sm lg:text-base mb-4 font-light font-description"
                        >
                            {detailData.release_date ? detailData.release_date.substring(0,4) : "-"} | {detailData.runtime ? durationFormatter(detailData.runtime) : "-"} | &nbsp;
                            {detailData.genres ? detailData.genres.map( (items, index) => {
                ...
                <div className="flex flex-col w-full content-center justify-start px-3 sm:px-5 xl:px-8 sm:z-10 sm:absolute h-full sm:h-96 lg:h-120 xl:h-140 sm:bg-gradient-to-r sm:from-black sm:via-black">
                    <div className="my-auto xl:pb-20 sm:w-1/2">
                        ...
                        <p 
                            className="sm:text-sm lg:text-base mb-4 font-light font-description"
                        >
                            {detailData.first_air_date ? detailData.first_air_date.substring(0,4) : "-"} | {detailData.number_of_seasons && detailData.number_of_seasons == 1 ? `${detailData.number_of_seasons} Season` : detailData.number_of_seasons >= 2 ? `${detailData.number_of_seasons} Seasons` : ""} &nbsp; 
