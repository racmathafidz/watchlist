...
export default function Tv(props) {
  const {
    tvTrending, tvPopular, tvAiring, actionData, comedyData, dramaData, animationData,
  } = props;

  // Get 5 Movie for Carousel
  const tvTrendingSlide = tvTrending.filter((items, index) => index <= 4);
...
export const getServerSideProps = async () => {
  ...
  const filteredTvTrendingData = tvTrending.results.filter((items) => items.backdrop_path !== null && items.poster_path !== null);
  ...
  const filteredTvPopularData = tvPopular.results.filter((items) => items.backdrop_path !== null && items.poster_path !== null);
  ...
  const filteredTvAiringData = tvAiring.results.filter((items) => items.backdrop_path !== null && items.poster_path !== null);
  ...
  const filteredDramaData = dramaData.results.filter((items) => items.backdrop_path !== null && items.poster_path !== null);
  ...
  const filteredAnimationData = animationData.results.filter((items) => items.backdrop_path !== null && items.poster_path !== null);
